    ...
    <section id="cobertura" className="scroll-mt-24 px-4 py-16 sm:px-6">
      <div className="mx-auto max-w-6xl">
        <RevealSection className="grid gap-10 rounded-3xl border border-white/10 bg-black/20 p-8 sm:p-10 lg:grid-cols-[1fr_minmax(0,1.15fr)] lg:gap-14">
          <RevealBlock className="space-y-4 border-l-[3px] border-sky-400/65 pl-5">
            <p className="font-mono text-[10px] font-semibold uppercase tracking-[0.26em] text-sky-300/95">
              {t("eyebrow")}
            </p>
            ...
            <div className="flex flex-wrap gap-2 pt-2">
              {t.raw("pairChips").map((pair: string) => (
                <span
                  key={pair}
                  className="rounded-full border border-sky-500/30 bg-sky-950/30 px-2.5 py-1 font-mono text-[10px] font-medium uppercase tracking-wider text-sky-100/95"
                >
                  {pair}
                </span>
              ))}
          ...
          <NestStaggerRoot as="div" className="grid gap-4 sm:grid-cols-3">
            <RevealBlock tight className="surface-rise rounded-2xl border border-white/[0.08] bg-white/[0.03] p-4">
              <Landmark className="size-5 text-amber-400/85" aria-hidden />
            ...
            <RevealBlock tight className="surface-rise rounded-2xl border border-white/[0.08] bg-white/[0.03] p-4">
              <Bitcoin className="size-5 text-sky-400/90" aria-hidden />
            ...
            <RevealBlock tight className="surface-rise rounded-2xl border border-white/[0.08] bg-white/[0.03] p-4">
              <ShieldCheck className="size-5 text-emerald-400/85" aria-hidden />
