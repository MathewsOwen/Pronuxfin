...
export function getSingularityViewportProfile(
  ...
  return {
    ...
    instanceCount: shortFrame
      ...
      : mode === "ambient"
        ...
        : isPortrait
          ...
          : 1020,
    pixelRatioCap: 1.5,
    camDistance: intro ? (shortFrame ? 78 : isPortrait ? 86 : 82) : isPortrait ? 100 : 94,
    orbitRadius: intro ? (shortFrame ? 26 : isPortrait ? 28 : 30) : isPortrait ? 36 : 38,
    orbitSpread: 0,
    crystalRadius: intro ? 0.46 : 0.38,
    sphereSegments: 32,
    labelCompact: true,
    ...
    diskIntensity: 1.28,
    auraIntensity: 1.05,
    fov: intro ? (shortFrame ? 46 : 44) : 42,
    cameraPitch: 0.33,
    cameraYOffset: 0,
    targetYOffset: intro ? -2.2 : 0,
    centeredView: false,
    fixedCamera: intro,
    autoRotate: !intro,
    crystalOrbitScale: 1,
    diskMorph: intro ? 0.07 : 0.1,
    antialias: true,
