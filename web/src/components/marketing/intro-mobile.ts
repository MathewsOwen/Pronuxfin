    ...
    instanceCount: shortFrame
      ...
      : mode === "ambient"
        ...
        : isPortrait
          ...
          : 1020,
    pixelRatioCap: 1.5,
    camDistance: intro ? (shortFrame ? 70 : isPortrait ? 74 : 78) : isPortrait ? 100 : 94,
    orbitRadius: intro ? (shortFrame ? 22 : isPortrait ? 24 : 26) : isPortrait ? 36 : 38,
    orbitSpread: 0,
    crystalRadius: intro ? 0.52 : 0.38,
    sphereSegments: 32,
    labelCompact: true,
    showCrystalLabels: intro,
    crystalLockedOrbit: true,
    diskRMax: intro ? (shortFrame ? 34 : 36) : 40,
    diskOrbitScale: 0.72,
    diskIntensity: 1.28,
    auraIntensity: 1.05,
    fov: intro ? (shortFrame ? 52 : 48) : 42,
    cameraPitch: intro ? 0.26 : 0.34,
    cameraYOffset: 0,
    centeredView: intro,
    autoRotate: !intro,
    crystalOrbitScale: intro ? 1.85 : 1,
    antialias: true,
    toneMappingExposure: intro ? 1.74 : 1.38,
